			...
			<div class="table-responsive">														
				...
				if (isset($data['row']))
				{
					...
					<tr>
						...
						<td>
							<a href="<?=$row['edit']?>" title="Редактировать"><?=$row['news_date']?></a>
						</td>
						<td>
							<?=$row['start']?>
						</td>
						...
						<td>
							<? if (!empty($row['del'])) {?>
							<a class="delete" href="<?=$row['del']?>" onClick="return confirm ('Вы действительно хотите удалить данный слайд?');" title="Удалить"><i class="fa fa-minus-circle"></i></a>
							<?}?>			
						</td>
					</tr>
					<?}
