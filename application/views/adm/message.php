		...
		<div class="main-content">	
			<div class="row head-search">
				<div class="col-sm-12">
					...
					<div class="col-md-3">
						<br>
						<a class="btn btn-flat btn-danger" href="/adm/<?=$data["table_name"]?>/delnotactivate" onClick="return confirm ('Вы действительно хотите удалить все неактивные сообщения?');" title="Удалить"><i class="fa fa-minus-circle"></i> Удалить все неактивные</a>
					</div>
			...
			<div class="table-responsive">														
				...
				{?>
					<tr><td colspan="11" align="center"><?=$data['empty_row']?></td></tr>
				<?}?>
			</tbody>
			</table>
			</div>
