			...
			<div class="table-responsive">														
				...
				if (isset($data['article_row']))
				{
					...
					<tr class="<?=$row['status']?>">
						...
						<td>
							<a class="edit" href="/adm/shop/copy?id=<?=$row['id']?>" title="Скопировать элемент"><i class="fa fa-clone"></i></a>
						</td>
						<td>
							<?=$row['tags']?>
						</td>
						<td>
							<a href="/adm/fields_value/?parent_id=<?=$row['id']?>" title="Дополнительные поля"><i class="fa fa-cart-arrow-down"></i></a>
						</td>
						<td>
							<?=$row['order_index']?>
						</td>
