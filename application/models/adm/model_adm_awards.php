...
*/
class Model_Adm_Awards extends Model 
{

	var $table_name = 'awards';
	var $primary_key = 'award_id';
	var $orderType = array ("award_id"=>"", "title" =>"", "news_date"=>"", "order_index" => "", "is_active" => "");
	var $orderDefault = "order_index";
	var $orderDirDefault = "asc";
	var $path_img = "/media/awards/";
	var $rowsPerPage = 15;
	...
	function Insert()
	{
		...
		{			
			...
			$xsize = $this->db->GetSetting("XSizeAwards", 200);
            $ysize = $this->db->GetSetting("YSizeAwards", 200);
