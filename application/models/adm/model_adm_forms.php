...
*/
class Model_Adm_Forms extends Model 
{

	var $table_name = 'forms';
	var $primary_key = 'form_id';
	...
	{							
		...
		{			
			...
			{				
				...
				$totalphotos = $this->db->GetOne("SELECT Count(*) FROM form_item WHERE parent_id = '$id'", 0);
