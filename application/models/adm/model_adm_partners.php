...
*/
class Model_Adm_Partners extends Model 
{

	var $table_name = 'partners';
	var $primary_key = 'partner_id';
	var $orderType = array ("partner_id"=>"", "title" =>"", "news_date"=>"", "order_index" => "", "is_active" => "");
	var $orderDefault = "order_index";
	var $orderDirDefault = "asc";
	var $path_img = "/media/partners/";
	var $rowsPerPage = 15;
