...
class Model_Adm_Actions extends Model 
{
	...
	function Insert()
	{
		...
		else
		{
			...
			$xsize = $this->db->GetSetting("XSizeActions", 200);
            $ysize = $this->db->GetSetting("YSizeActions", 200);
